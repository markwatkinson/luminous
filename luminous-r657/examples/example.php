...
<head>
  ...
  <?php 
  /* As of 0.5.0 this is the preferred way to include 
   * the stylesheets and javascript.
   * All arguments are optional, but you will have to set the 
   * last one if you have your luminous directory outside
   * of your document root. */
  echo luminous_get_html_head('luminous_light', // theme (any stylesheet
                                              // in style/
                              true, // JavaScript?
                              true, // jQuery? [you need jquery for JavaScript
                                    // but may instead include a different 
                                    // version yourself elsewhere]
                              $http_path // this is the path to your
                              // luminous dir relative to the document root. 
                              // Luminous will try to figure this out
                              // if you don't provide it, but it's not
                              // reliable if you are using symlinks
      );
  ?>
...
You could also set the height using $LUMINOUS_WIDGET_HEIGHT. Note that if you plan to restrict the height with containers, you should set 
$LUMINOUS_WIDGET_HEIGHT=0 (Luminous will try to size itself by default).
</p>
<div style='width:50%; height: 250px; margin-left:auto; margin-right:auto; border:1px solid black; overflow:auto'>
<?php
$LUMINOUS_WIDGET_HEIGHT = -1;
echo luminous('php', <<<EOF
/**
