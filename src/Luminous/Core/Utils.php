...
class Utils
{
     ...
     *    character.
     */
    public static function balanceDelimiter($delimiter)
    {
        switch ($delimiter) {
            case '(':
                return ')';
     ...
     */
    public static function tagBlock($type, $block, $splitMultiline = true)
    {
        if ($type === null) {
            return $block;
        }
     ...
     */
    public static function pcreErrorDecode($errcode)
    {
        switch ($errcode) {
            case PREG_NO_ERROR:
